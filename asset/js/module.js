...
function moduleShowCart(API=[],carts=[]){
    let total=0;
    const vat=5;
    const html=carts.map(item=>{
        ...
        <div class="table__content--amount">
            <div class="table__content--quantity__contain">
                <button data-id="${id}" data-type="decrease" class="handleAmountCart"><i class="fa-solid ${item.amount<=1?'fa-trash-can':'fa-minus'}"></i></button>
